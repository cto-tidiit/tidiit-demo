...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 06, 2015 at 03:01 PM
...
INSERT INTO `banner` (`bannerId`, `pageId`, `image`, `status`) VALUES
(4, 1, '1432539931.jpg', 1),
(5, 2, '1432540035.jpg', 1);
...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0=>General,1=>Ocasional',
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `dealPriceUpdateTime` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `title` varchar(255) NOT NULL,
  ...
  `isDeals` tinyint(1) NOT NULL DEFAULT '0',
  `isNew` tinyint(1) NOT NULL DEFAULT '0',
  `termsData` tinyint(1) NOT NULL DEFAULT '0',
  `popular` tinyint(1) NOT NULL DEFAULT '0',
  `dealPrice` float(10,2) DEFAULT NULL,
...
INSERT INTO `product_deal` (`productDealId`, `productId`, `categoryId`) VALUES
(1, 3032, 21),
(2, 2969, 21),
(3, 403, 16),
(4, 961, 18);
...
(1, 'AdminMail', 'admin@dailyplaza.com', 'Admin Mail'),
(2, 'SiteMail', 'sales@dailyplaza.com', 'site mail'),
(3, 'MetaTitle', 'Send Flowers, Cakes, Wines Online | Buy Online : Rakhi Gifts, Cakes, Flowers, Wine | Lowest Price Shop in World at Dailyplaza', 'Online Gifting Portal | Valentine''s Day Gifts Online| Buy Online : Rakhi Gifts, Cakes, Flowers, Wine | Lowest Price Shop in World at Dailyplaza'),
(4, 'MetaKeyWord', 'Send Valentines Wishes Online, Send Rakhi to USA, Send Rakhi Gift Online, Send Cakes to India, Send Flowers Online, Gift Wine online, Send Wine to UK', 'Valentine Gifts to USA'),
(5, 'SupportEmail', 'support@dailyplaza.com', 'Email id for support inquiry message'),
(6, 'MetaDescription', 'Fresh Flowers, Wines, Birthday Cakes : Dailyplaza.com. Send Rakhi Gift Online, Send Cakes, Send Flowers, Send online wine Gifts in all over world at the lowest prices', 'Online Gifting Portal | Cakes , Flowers : Dailyplaza.com. Send Rakhi Gift Online, Send Cakes, Send Flowers, Send online wine Gifts in all over world at the lowest prices'),
(7, 'OrderMail', 'customerservice@dailyplaza.com', 'Order Mail'),
(8, 'ContactUsMail', 'contacts@dailyplaza.com', NULL),
(9, 'MobileAppFlatDiscountIN', '100', 'This Discount get if user use mobile app while puring in india');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `userType` enum('buyer','seller','support','admin','accounts','supply_chain','supper_admin') NOT NULL DEFAULT 'buyer',
