...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 31, 2015 at 07:34 AM
...
INSERT INTO `brand` (`brandId`, `title`, `brandImage`, `status`) VALUES
(1, 'test', '1436699668.jpg', 1),
(2, 'Lava', NULL, 1),
(3, 'Lava', NULL, 1);
...
INSERT INTO `brand_user` (`brandUserId`, `brandId`, `userId`) VALUES
(1, 3, 4);
...
INSERT INTO `category` (`categoryId`, `parrentCategoryId`, `categoryName`, `isTop`, `image`, `status`, `showProduct`, `isAddToCart`, `description`, `metaTitle`, `metaKeyWord`, `metaDescription`, `note`, `extraNote`) VALUES
(1, 0, 'Electronics', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Electronics', NULL),
(2, 0, 'Fashion', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Fashion', NULL),
(3, 0, 'Medicine', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Medicine', NULL),
(4, 0, 'Grocery', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Grocery', NULL),
(5, 1, 'Mobile Phone', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Mobile Phone', NULL),
(6, 1, 'Laptop', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Laptop', NULL),
(7, 1, 'Desktop', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Desktop', NULL),
(8, 1, 'Tablets', 1, NULL, 1, 1, 1, NULL, '', '', '', 'Tablets', NULL);
...
INSERT INTO `page_type_user` (`pageTypeUserId`, `pageType`, `userId`) VALUES
(1, 'mobile', 4);
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `mobileColor` tinyint(1) NOT NULL,
  ...
  `frontCamera` float(3,1) DEFAULT NULL,
  `mobileRearCamera` float(3,1) DEFAULT NULL,
  `mobileFlash` tinyint(1) DEFAULT NULL,
  `multiLanguages` tinyint(1) DEFAULT NULL,
  `osVersion` tinyint(4) DEFAULT NULL,
  ...
  `mobileBatteryType` tinyint(4) DEFAULT NULL,
